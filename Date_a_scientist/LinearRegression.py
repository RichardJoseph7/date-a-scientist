...
#traning our model with our training data
regr_obj.fit(x_train,y_train)
#now lets test out our fit against the test data
y_predicted = regr_obj.predict(x_test)


# this is our accuracy
print('Our regression score is: ', regr_obj.score(y_test, y_predicted))

#printing test data vs our predicted data
plt.xlabel('Age')
